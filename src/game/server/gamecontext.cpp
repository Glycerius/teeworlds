...
void CGameContext::OnMessage(int MsgID, CUnpacker *pUnpacker, int ClientID)
{
	...
	if(MsgID == NETMSGTYPE_CL_SAY)
	{
		...
		{
			SendChatTarget(ClientID, "======= Mod Information =======");
			SendChatTarget(ClientID, "iLevel Mod 0.5 Beta.");
			SendChatTarget(ClientID, "Developers: Glycerius and Learath2.");
			SendChatTarget(ClientID, "Write /cmdlist for list of all commands.");
		}
		else if(!str_comp_nocase(pMsg->m_pMessage, "/cmdlist"))
		{
			SendChatTarget(ClientID, "======= Command List =======");
			SendChatTarget(ClientID, "Information: /info");
			SendChatTarget(ClientID, "Credits: /credits");
			SendChatTarget(ClientID, "Suicide: /suicide");
		}
		else if(!str_comp_nocase(pMsg->m_pMessage, "/credits"))
		{
		...
		{
			SendChatTarget(ClientID, "Unknown command. Write /cmdlist for list of all commands.");
		}
		else
		{
...
void CGameContext::OnInit(/*class IKernel *pKernel*/)
{
	...
	// select gametype
	m_pController = new CGameControllerILevel(this);
